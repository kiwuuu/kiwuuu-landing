...
export function Hero({ eyebrow, headline, sub, prefill }: Props) {
  return (
    <section className="relative overflow-hidden px-6 pt-16 pb-20 sm:pt-24 sm:pb-28">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <h1 className="mt-6 text-balance text-4xl font-bold tracking-tight text-[var(--ink)] sm:text-6xl md:text-[72px] md:leading-[1.05]">
          {headline}
        </h1>
        ...
        <div className="mt-10 flex flex-col items-center gap-4">
          ...
          <p className="mt-2 text-xs text-[var(--muted)]">
            24h Live SLA · GDPR Art. 28 compliant · Cancel anytime
          </p>
        </div>
      </div>
    </section>
