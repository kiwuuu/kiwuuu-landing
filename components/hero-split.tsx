...
export function HeroSplit({ eyebrow, headline, sub, prefill, visual, ctaLabel }: Props) {
  return (
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 md:grid-cols-2 md:gap-16">
        <div>
          ...
          <div className="mt-10 flex flex-col items-start gap-4">
            <WaButton prefill={prefill} size="lg" label={ctaLabel} />
            <a
              href={CALENDAR_URL}
              target="_blank"
        ...
        <div className="flex justify-center md:justify-end">{visual}</div>
      </div>
    </section>
  );
}
